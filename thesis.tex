...
% For printing:
\documentclass[a4paper,12pt,times,numbered,print,oneside]{PhDThesisPSnPDF}

% For online pdf:
%\documentclass[a4paper,12pt,times,numbered]{PhDThesisPSnPDF}
...
% Multiple chapters can be listed. To hide Todo notes or add table of contents
% or figures, edit Preable/chapter.tex
...
%\include{7_Chapter7/chapter7}
%\include{n_Conclusion/Conclusion}
